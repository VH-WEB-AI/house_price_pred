...
# TARGET      = "Price_USD"
# POLY_DEGREE = 2      # degree=2 → 99.6% R², verified via 5-fold CV
# RIDGE_ALPHA = 1.0    # mild regularisation — prevents overfitting on poly terms

# # Dataset — keep house_pricing_dataset_2000.xlsx in the same folder as this script
...
# # ─────────────────────────────────────────────────────────────────────────────
# # CSS  ← ONLY THIS SECTION IS CHANGED
# # ─────────────────────────────────────────────────────────────────────────────
# st.markdown("""
# <style>
#   /* ── Google Fonts ── */
...
#     box-shadow: 0 20px 60px rgba(0,0,0,0.45), inset 0 1px 0 rgba(201,168,76,0.15);
...
#     background: rgba(253,246,227,0.06) !important;
...
#   }
#   .result-price span { color: var(--gold2); }
#   .result-range {
#     font-size: 13px;
#     color: var(--muted);
#     margin-top: 8px;
...
#     # Format price with dollar sign highlighted
